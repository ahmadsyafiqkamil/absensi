...
export async function GET(
  ...
  try {
    ...
    const backendUrl = `${BACKEND_URL}/api/v2/overtime/supervisor/monthly-summary/${id}/${url.search}`;
...
export async function PUT(
  ...
  try {
    ...
    const backendUrl = `${BACKEND_URL}/api/v2/overtime/supervisor/monthly-summary/${id}/`;
