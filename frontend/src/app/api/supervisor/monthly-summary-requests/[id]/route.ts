...
export async function GET(
  ...
  try {
    ...
    const backendUrl = `${BACKEND_URL}/api/supervisor/overtime-summary-requests/${id}/${url.search}`;
...
export async function PUT(
  ...
  try {
    ...
    const backendUrl = `${BACKEND_URL}/api/supervisor/overtime-summary-requests/${id}/`;
