...
from .models import Division, Position, Employee, WorkSettings, Holiday, Attendance, AttendanceCorrection, OvertimeRequest, MonthlySummaryRequest, GroupPermission, GroupPermissionTemplate, EmployeeRole, RoleConfiguration
...
class RoleConfigurationSerializer(serializers.ModelSerializer):
    """
    Serializer untuk RoleConfiguration - Basic read/write operations
    """
    ...
    def validate(self, data):
        ...
        if data.get('role_type') == 'primary':
            existing_primary = RoleConfiguration.objects.filter(
                role_type='primary',
                is_active=True
...
class RoleConfigurationCreateSerializer(serializers.ModelSerializer):
    """
    Serializer untuk create RoleConfiguration
    """
    class Meta:
        model = RoleConfiguration
        fields = [
...
class RoleConfigurationUpdateSerializer(serializers.ModelSerializer):
    """
    Serializer untuk update RoleConfiguration
    """
    class Meta:
        model = RoleConfiguration
        fields = [
...
class RoleConfigurationDetailSerializer(serializers.ModelSerializer):
    """
    Serializer untuk detail RoleConfiguration dengan informasi tambahan
    """
    role_type_display = serializers.CharField(source='get_role_type_display', read_only=True)
    user_count = serializers.SerializerMethodField()
