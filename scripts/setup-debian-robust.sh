...
# Robust setup script untuk Debian
# Menangani berbagai versi Debian dan package yang tidak tersedia

set -e

echo "🚀 Robust Setup untuk Debian Server"
echo "==================================="
...
if [ "$EUID" -ne 0 ]; then
    ...
    echo "2. Run this script: curl -fsSL https://raw.githubusercontent.com/ahmadsyafiqkamil/absensi/main/scripts/setup-debian-robust.sh | bash"
